...
export default function FieldAuditsPage() {
  ...
  const loadAudits = useCallback(async () => {
    ...
    try {
      ...
      const request = await fetch("/api/crm/field-audits", { headers: { Authorization: `Bearer ${token}` } });
  ...
  async function authenticatedRequest(method: "POST" | "PATCH", payload: Record<string, unknown>) {
    ...
    try {
      ...
      const request = await fetch("/api/crm/field-audits", { method, headers: { Authorization: `Bearer ${token}`, "Content-Type": "application/json" }, body: JSON.stringify(payload) });
