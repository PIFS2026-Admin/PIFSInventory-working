...
type ApiResponse = { ok?: boolean; job?: Job; phases?: Phase[]; runs?: Run[]; run?: Run | null; racks?: Rack[]; calibrations?: Calibration[]; assets?: Asset[]; escalations?: Escalation[]; documents?: JobDocument[]; defectDecisions?: DefectDecision[]; tubularSpecs?: TubularSpec[]; dimensionalReadings?: DimensionalReading[]; connectionRefacing?: ConnectionRefacing[]; summary?: Summary; error?: string };
