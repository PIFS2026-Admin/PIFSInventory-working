...
type ApiResponse = { ok?: boolean; job?: Job; phases?: Phase[]; runs?: Run[]; run?: Run | null; racks?: Rack[]; calibrations?: Calibration[]; assets?: Asset[]; escalations?: Escalation[]; documents?: JobDocument[]; defectDecisions?: DefectDecision[]; tubularSpecs?: TubularSpec[]; dimensionalReadings?: DimensionalReading[]; summary?: Summary; error?: string };
