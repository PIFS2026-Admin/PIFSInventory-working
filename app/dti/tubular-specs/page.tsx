...
export default function TubularSpecsPage() {
  ...
  return <main className={styles.page}>
    <header className={`${styles.header} titan-page-header`}><div className={styles.title}><Image src="/titan_logo.jpg" alt="TITAN" width={64} height={42} priority /><div><span>DTI</span><h1>Tubular Specifications</h1></div></div><div className={styles.actions}><button type="button" onClick={() => goBackOrFallback("/service-lines/dti")}>Back</button><Link href="/dti/acceptance-criteria">Criteria</Link><Link href="/dti/documents">Documents</Link><DtiProcedureMenu procedures={[{documentNumber:"PFIS-IOM-001",label:"Inspection Operations Manual"},{documentNumber:"OMS-102",label:"Service Categories"},{documentNumber:"OMS-105",label:"Defect Decisions"},{documentNumber:"OMS-106",label:"Dimensional Reference"},{documentNumber:"OMS-107",label:"Connection and Refacing"},{documentNumber:"OMS-108",label:"EMI and UT Calibration"},{documentNumber:"OMS-109",label:"Escalation Flow"}]}/><button type="button" onClick={() => void load()}>Refresh</button></div></header>
