    ...
    <main className="dashboard-shell dti-shell">
      ...
      <header className="dashboard-header titan-page-header">
        <button className="brand compact brand-home-link" type="button" onClick={() => (window.location.href = "/home")}>
          ...
          <div>
            <div className="brand-title">Historical DTI Job Reviews</div>
          </div>
        </button>

        <div className="dashboard-actions">
          <button className="button" onClick={() => (window.location.href = "/dti")}>DTI Management</button>
          <button className="button" onClick={() => (window.location.href = "/dti/competency")}>Inspector Competency</button>
          <button className="button" onClick={() => (window.location.href = "/dti/crew-schedule")}>Crew Schedule</button>
      ...
      <section className="dashboard-hero">
        ...
        <p>Preserved DTI work orders and scorecards created before the connected-job audit workflow.</p>
      </section>
