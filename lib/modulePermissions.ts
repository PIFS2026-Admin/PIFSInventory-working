...
const roleDefaults: Record<string, ModuleKey[]> = {
  ...
  service_line_manager: ["yard_view", "inventory", "purchase_orders", "dti", "dti_summary", "hardband", "reports", "dashboard"],
  inventory_manager: ["yard_view", "inventory", "purchase_orders", "dashboard"],
  inventory_specialist: ["yard_view", "inventory", "purchase_orders", "dashboard"],
  dti_superintendent: ["dti", "dti_summary"],
  dti_lead: ["inventory", "dti_summary"],
  dti_inspector: ["dti_summary"],
  level_2_inspector: ["inventory", "dti_summary"],
  hardband_lead: ["inventory", "hardband"],
  cdt_lead: ["inventory"],
  operator: ["hardband"],
